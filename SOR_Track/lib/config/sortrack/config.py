...
# MODEL 
cfg.MODEL = edict()
cfg.MODEL.ARCH_MODE        = "base"
cfg.MODEL.STEM_SCALE       = 4
cfg.MODEL.SOR_K            = 4
cfg.MODEL.REDUCTION_STRIDE = 1
cfg.MODEL.USE_STEM         = True
...
cfg.MODEL.TMA_GROUPS       = 4
cfg.MODEL.SOR_PRETRAIN_FILE = ''
...
cfg.TRAIN.SCHEDULER.WARMUP_EPOCH = 0      
cfg.TRAIN.SCHEDULER.WARMUP_LR_INIT = 1e-6 
...
cfg.DATA.EVENT_MEAN          = [0.0586, 0.0865, 0.0461]
cfg.DATA.EVENT_STD           = [0.2108, 0.2623, 0.1727]
...
cfg.TEST.EPOCH           = 500
cfg.TEST.EVENT_NORM_MODE = "imagenet"
cfg.TEST.VIS_SOR   = False 
cfg.TEST.VIS_EVERY = 10    
...
def update_config_from_file(filename, base_cfg=None):
    ...
    target = base_cfg if base_cfg is not None else cfg
    _update_config(target, exp_config)