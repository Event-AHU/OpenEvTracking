...
class VisEvent(BaseVideoDataset):
    ...
    def _get_first_frame_no(self, seq_path):
        frame_no = sorted(os.listdir(seq_path))[0][5:9]
        return frame_no
    ...
    def _get_frame_path(self, seq_path, frame_id): 
        frame_no = self._get_first_frame_no(seq_path)
        frame_id = int(frame_no) + frame_id
