    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                template_frame_list = [np.concatenate([rgb, event], axis=2) for rgb, event in zip(template_aps_frame_list, template_dvs_frame_list)]
                search_frame_list = [np.concatenate([rgb, event], axis=2) for rgb, event in zip(search_aps_frame_list, search_dvs_frame_list)]
                H, W, _ = template_frame_list[0].shape
                ...
                data = TensorDict({'template_images': template_frame_list,
                                   'template_anno': template_anno['bbox'],
                                   'template_masks': template_masks,
                                   'search_images': search_frame_list,
