...
class COESOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        aps_seq_path = '{}/{}/{}'.format(self.base_path, sequence_name, sequence_name+'_aps')
        ...
        dvs_seq_path = '{}/{}/{}'.format(self.base_path, sequence_name, sequence_name+'_dvs')
        ...
        return Sequence(sequence_name, aps_frame_list, 'COESOT', ground_truth_rect, dvs_frame_list=dvs_frame_list)  