...
class Sequence:
    ...
    def __init__(self, name, aps_frame_list, dataset, ground_truth_rect, ground_truth_seg=None, init_data=None,
                 object_class=None, target_visible=None, object_ids=None, multiobj_mode=False, 
                 dvs_frame_list=None, event_voxel_list=None):
        self.name = name
        self.aps_frame_list = aps_frame_list       
        self.dvs_frame_list = dvs_frame_list         
        self.event_voxel_list = event_voxel_list               
