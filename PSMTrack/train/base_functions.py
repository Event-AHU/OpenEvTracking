...
# datasets related
from lib.train.dataset import Lasot, Got10k, MSCOCOSeq, ImagenetVID, TrackingNet, EventVOT, Coesot, Fe240, VisEvent
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full", "GOT10K_official_val",
                        ...
                        "COESOT", "COESOT_VAL", "FE240", "FE240_VAL", "VisEvent", "VisEvent_VAL", "EventVOT", "EventVOT_VAL"]
        if name == "LASOT":
        ...
        if name == "EventVOT_VAL":
            datasets.append(EventVOT(settings.env.eventvot_val_dir, split='val', image_loader=image_loader))
    return datasets
