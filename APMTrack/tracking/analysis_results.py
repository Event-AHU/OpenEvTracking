...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='coesot', help='coesot or fe108 or felt or eed.')
    parser.add_argument('--parameter_name', type=str, default='amptrack_coesot', help='coesot or fe108 or fe or eed.')
    ...
    """amptrack"""
    trackers.extend(trackerlist(name='amptrack', parameter_name=args.parameter_name, dataset_name=dataset_name,
                                run_ids=None, display_name='AMPTrack256'))
