...
if __name__ == '__main__':
    ...
    training_subset = True # False / True
    data_path = '/wangx/DATA/Dataset/COESOT/train/'
    save_path = '/wangx/DATA/Dataset/COESOT/new_voxel/train/'
    ...
    for videoID in tqdm(range(len(video_files))):
        ...
        if foldName == 'list.txt' or foldName == 'train.txt' or foldName == 'val.txt':
            continue
