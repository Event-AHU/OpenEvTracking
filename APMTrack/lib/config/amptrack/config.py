...
"""
Add default config for amptrack.
"""
cfg = edict()
...
cfg.MODEL.PRETRAIN_TYPE = "pretrained/itpn/fast_itpn_base_clipl_e1600.pt"
...
cfg.MODEL.BACKBONE.PATCHEMBED_INIT = "halfcopy" # copy, halfcopy, random
...
cfg.MODEL.BACKBONE.TOKEN_TYPE_INDICATE = True
